CREATE TABLE "context_attachments" (
	...
	CONSTRAINT "context_attachments_owner_check" CHECK (("context_attachments"."agent_id" is null) <> ("context_attachments"."skill_id" is null))
);
...
CREATE INDEX "context_attachments_workspace_idx" ON "context_attachments" USING btree ("workspace_id");