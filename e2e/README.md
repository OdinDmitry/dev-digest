...
| `08-skills` | `/skills` → seeded skill card → click → preview pane renders the body |
| `09-agent-skills` | agents → Test Quality Reviewer → Skills tab → linked skills + order hint |
